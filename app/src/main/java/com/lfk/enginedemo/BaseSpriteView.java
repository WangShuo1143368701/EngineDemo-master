 ...
 * @author wangshuo
 */
public class BaseSpriteView extends BaseSub {
    // 名称
     ...
     * @param engine
     */
    public BaseSpriteView(Context mContext, EngineView engine) {
        this(mContext,engine, 0, 0, 1);
     ...
     * @param type
     */
    public BaseSpriteView(Context mContext, EngineView engine, int w, int h, FrameType type) {
        switch (type) {
            case SIMPLE:
     ...
     * @param columns
     */
    public BaseSpriteView(Context mContext, EngineView engine, int w, int h, int columns) {
        this.s_engine = engine;
        this.s_width = w;
        this.s_height = h;
    ...
    private void init() {
        s_alpha = 255;
        s_canvas = null;
        s_texture = new GameTexture(mContext);
        s_paint = new Paint();
